/// <amd-module name="@scom/scom-scraper/types.ts" />
declare module "@scom/scom-scraper/types.ts" {
...
declare module "@scom/scom-scraper" {
    ...
    import { ICookie, ICookieParam, IKeyInput, IPageEvent, IPageLifeCycle } from "@scom/scom-scraper/types.ts";
